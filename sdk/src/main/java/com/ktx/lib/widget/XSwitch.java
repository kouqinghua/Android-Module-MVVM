 ...
 * SwitchButton.
 */
public class XSwitch extends View implements Checkable {
    ...
    private void drawArc(Canvas canvas, float left, float top, float right, float bottom, Paint paint) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            canvas.drawArc(left, top, right, bottom, (float) 90, (float) 180, true, paint);
        } else {
            rect.set(left, top, right, bottom);
            canvas.drawArc(rect, (float) 90, (float) 180, true, paint);
        }
    }
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(XSwitch view, boolean isChecked);
    }
