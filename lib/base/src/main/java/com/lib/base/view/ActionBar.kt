...
import com.lib.base.app.BaseConfig
import com.lib.base.databinding.ActionBarBinding
...
class ActionBar : RelativeLayout {
    ...
    private lateinit var mBinding: ActionBarBinding
    ...
    private fun init(context: Context) {
        mContext = context
        val view = View.inflate(context, R.layout.action_bar, null)
